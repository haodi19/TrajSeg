...
class MultiReasonSegDataset(torch.utils.data.Dataset):
    ...
    def __init__(
        ...
        json_file_name = os.path.join(self.base_image_dir, 'MUSE', 'MUSE_train.json')
...
if __name__ == "__main__":
    ...
    dataset = MultiReasonSegDataset('lisa', tokenizer, 'openai/clip-vit-large-patch14')
