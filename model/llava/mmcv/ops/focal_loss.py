...
class SigmoidFocalLossFunction(Function):
    ...
    def forward(ctx,
        ...
        text_module.sigmoid_focal_loss_forward(
    ...
    def backward(ctx, grad_output):
        ...
        text_module.sigmoid_focal_loss_backward(
            input,
            target,
            weight,
            grad_input,
...
class SoftmaxFocalLossFunction(Function):
    ...
    def forward(ctx,
        ...
        text_module.softmax_focal_loss_forward(
            input_softmax,
            target,
            weight,
            output,
    ...
    def backward(ctx, grad_output):
        ...
        text_module.softmax_focal_loss_backward(
            input_softmax,
            target,
            weight,
            buff,
