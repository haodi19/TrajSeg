...
class TopPoolFunction(Function):
    ...
    def forward(ctx, input):
        output = text_module.top_pool_forward(input)
    ...
    def backward(ctx, grad_output):
        ...
        output = text_module.top_pool_backward(input, grad_output)
        return output
...
class BottomPoolFunction(Function):
    ...
    @staticmethod
    def forward(ctx, input):
        output = text_module.bottom_pool_forward(input)
        ctx.save_for_backward(input)
        return output
    ...
    def backward(ctx, grad_output):
        input, = ctx.saved_tensors
        output = text_module.bottom_pool_backward(input, grad_output)
        return output
...
class LeftPoolFunction(Function):
    ...
    @staticmethod
    def forward(ctx, input):
        output = text_module.left_pool_forward(input)
        ctx.save_for_backward(input)
        return output
    ...
    def backward(ctx, grad_output):
        input, = ctx.saved_tensors
        output = text_module.left_pool_backward(input, grad_output)
        return output
...
class RightPoolFunction(Function):
    ...
    @staticmethod
    def forward(ctx, input):
        output = text_module.right_pool_forward(input)
        ctx.save_for_backward(input)
        return output
    ...
    def backward(ctx, grad_output):
        input, = ctx.saved_tensors
        output = text_module.right_pool_backward(input, grad_output)
        return output
