...
text_module = ext_loader.load_ext('_ext', ['fused_bias_leakyrelu'])
...
class FusedBiasLeakyReLUFunctionBackward(Function):
    ...
    def forward(ctx, grad_output, out, negative_slope, scale):
        ...
        grad_input = text_module.fused_bias_leakyrelu(
            grad_output,
            empty,
            out,
            act=3,
    ...
    def backward(ctx, gradgrad_input, gradgrad_bias):
        ...
        gradgrad_out = text_module.fused_bias_leakyrelu(
            gradgrad_input,
...
class FusedBiasLeakyReLUFunction(Function):
    ...
    def forward(ctx, input, bias, negative_slope, scale):
        ...
        out = text_module.fused_bias_leakyrelu(
            input,
            bias,
            empty,
            act=3,
