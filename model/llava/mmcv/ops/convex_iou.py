...
text_module = ext_loader.load_ext('_ext', ['convex_iou', 'convex_giou'])
...
def convex_giou(pointsets, polygons):
    ...
    text_module.convex_giou(pointsets, polygons, output)
...
def convex_iou(pointsets, polygons):
    ...
    text_module.convex_iou(pointsets, polygons, ious)
    return ious
