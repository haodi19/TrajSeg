...
def points_in_boxes_part(points, boxes):
    ...
    text_module.points_in_boxes_part_forward(boxes.contiguous(),
                                            points.contiguous(),
                                            box_idxs_of_pts)
...
def points_in_boxes_cpu(points, boxes):
    ...
    for b in range(batch_size):
        text_module.points_in_boxes_cpu_forward(boxes[b].float().contiguous(),
...
def points_in_boxes_all(points, boxes):
    ...
    text_module.points_in_boxes_all_forward(boxes.contiguous(),
                                           points.contiguous(),
                                           box_idxs_of_pts)
