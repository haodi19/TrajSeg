...
from model.llava.mmcv.runner import get_dist_info
from model.llava.mmcv.utils import print_log

from model.llava.mmdet.core import eval_map
...
class OpenImagesDataset(CustomDataset):
    ...
    def get_meta_from_pipeline(self, results):
        ...
        if dist.is_available() and self.world_size > 1:
            from model.llava.mmdet.apis.test import collect_results_cpu
