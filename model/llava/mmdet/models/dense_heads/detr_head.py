...
from model.llava.mmcv.cnn import Conv2d, Linear, build_activation_layer
from model.llava.mmcv.cnn.bricks.transformer import FFN, build_positional_encoding
from model.llava.mmcv.runner import force_fp32

from model.llava.mmdet.core import (bbox_cxcywh_to_xyxy, bbox_xyxy_to_cxcywh,
...
class DETRHead(AnchorFreeHead):
    ...
    def onnx_export(self, all_cls_scores_list, all_bbox_preds_list, img_metas):
        ...
        from model.llava.mmdet.core.export import dynamic_clip_for_onnx
