...
import torch
from model.llava.mmcv.cnn.utils.weight_init import constant_init
from model.llava.mmcv.ops import batched_nms
from model.llava.mmcv.runner import BaseModule, force_fp32

from model.llava.mmdet.core.utils import filter_scores_and_topk, select_single_mlvl
...
class BaseDenseHead(BaseModule, metaclass=ABCMeta):
    ...
    def onnx_export(self,
        ...
        for cls_score, bbox_pred, score_factors, priors in zip(
            ...
            from model.llava.mmdet.core.export import get_k_for_topk
