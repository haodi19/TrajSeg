...
from model.llava.mmcv.cnn import ConvModule, build_conv_layer, build_upsample_layer
from model.llava.mmcv.ops.carafe import CARAFEPack
from model.llava.mmcv.runner import BaseModule, ModuleList, auto_fp16, force_fp32
from torch.nn.modules.utils import _pair

from model.llava.mmdet.core import mask_target
...
class FCNMaskHead(BaseModule):
    ...
    def loss(self, mask_pred, mask_targets, labels):
        """
        Example:
            >>> from model.llava.mmdet.models.roi_heads.mask_heads.fcn_mask_head import *  # NOQA
    ...
    def get_seg_masks(self, mask_pred, det_bboxes, det_labels, rcnn_test_cfg,
        ...
        Example:
            >>> import model.llava.mmcv as mmcv
            >>> from model.llava.mmdet.models.roi_heads.mask_heads.fcn_mask_head import *  # NOQA
            >>> N = 7  # N = number of extracted ROIs
            >>> C, H, W = 11, 32, 32
            >>> # Create example instance of FCN Mask Head.
