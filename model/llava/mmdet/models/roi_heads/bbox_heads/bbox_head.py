...
from model.llava.mmcv.runner import BaseModule, auto_fp16, force_fp32
from torch.nn.modules.utils import _pair

from model.llava.mmdet.core import build_bbox_coder, multi_apply, multiclass_nms
from model.llava.mmdet.models.builder import HEADS, build_loss
from model.llava.mmdet.models.losses import accuracy
from model.llava.mmdet.models.utils import build_linear_layer
...
class BBoxHead(BaseModule):
    ...
    def refine_bboxes(self, rois, labels, bbox_preds, pos_is_gts, img_metas):
        ...
        Example:
            ...
            >>> import kwarray
            >>> import numpy as np
            >>> from model.llava.mmdet.core.bbox.demodata import random_boxes
    ...
    def onnx_export(self,
        ...
        from model.llava.mmdet.core.export import add_dummy_nms_for_onnx
