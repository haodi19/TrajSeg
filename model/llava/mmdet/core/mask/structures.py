...
import torch
from model.llava.mmcv.ops.roi_align import roi_align
...
class BitmapMasks(BaseInstanceMasks):
    ...
    Example:
        >>> from model.llava.mmdet.core.mask.structures import *  # NOQA
    ...
    def translate(self,
        ...
        Example:
            >>> from model.llava.mmdet.core.mask.structures import BitmapMasks
    ...
    def random(cls,
        ...
        """
        from model.llava.mmdet.utils.util_random import ensure_rng
        rng = ensure_rng(rng)
...
class PolygonMasks(BaseInstanceMasks):
    ...
    def random(cls,
        ...
        Example:
            >>> from model.llava.mmdet.core.mask.structures import PolygonMasks
