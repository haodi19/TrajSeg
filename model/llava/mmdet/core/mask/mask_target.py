...
def mask_target(pos_proposals_list, pos_assigned_gt_inds_list, gt_masks_list,
    ...
    Example:
        ...
        >>> import model.llava.mmdet
        >>> from model.llava.mmdet.core.mask import BitmapMasks
        >>> from model.llava.mmdet.core.mask.mask_target import *
        >>> H, W = 17, 18
...
def mask_target_single(pos_proposals, pos_assigned_gt_inds, gt_masks, cfg):
    ...
    Example:
        ...
        >>> import model.llava.mmdet
        >>> from model.llava.mmdet.core.mask import BitmapMasks
        >>> from model.llava.mmdet.core.mask.mask_target import *  # NOQA
        >>> H, W = 32, 32
