...
from model.llava.mmdet.core.bbox.iou_calculators import bbox_overlaps
from model.llava.mmdet.core.bbox.transforms import bbox_cxcywh_to_xyxy, bbox_xyxy_to_cxcywh
...
class BBoxL1Cost:
    """BBoxL1Cost.
     ...
     Examples:
         >>> from model.llava.mmdet.core.bbox.match_costs.match_cost import BBoxL1Cost
         >>> import torch
         >>> self = BBoxL1Cost()
...
class FocalLossCost:
    """FocalLossCost.
     ...
     Examples:
         >>> from model.llava.mmdet.core.bbox.match_costs.match_cost import FocalLossCost
         >>> import torch
         >>> self = FocalLossCost()
...
class ClassificationCost:
    """ClsSoftmaxCost.
     ...
     Examples:
         >>> from model.llava.mmdet.core.bbox.match_costs.match_cost import \
         ... ClassificationCost
         >>> import torch
...
class IoUCost:
    """IoUCost.
     ...
     Examples:
         >>> from model.llava.mmdet.core.bbox.match_costs.match_cost import IoUCost
         >>> import torch
         >>> self = IoUCost()
