...
def generate_inputs_and_wrap_model(config_path,
    ...
    try:
        from model.llava.mmcv.onnx.symbolic import register_extra_symbolics
...
def build_model_from_cfg(config_path, checkpoint_path, cfg_options=None):
    ...
    if 'CLASSES' in checkpoint.get('meta', {}):
        ...
        from model.llava.mmdet.datasets import DATASETS
...
def preprocess_example_input(input_config):
    ...
    Examples:
        >>> from model.llava.mmdet.core.export import preprocess_example_input
        >>> input_config = {
