...
def parse_args(args):
	...
	# YTVOS
	parser.add_argument("--mevis_path", type=str, required=True)
...
def main(args):
	...
	# 1. load data
	root = Path(args.mevis_path) # data/ref-youtube-vos
	...
	# done_videos = os.listdir('/hhd2/gaomingqi/ytvos_test/rvos_sam2_video_v3_1000/Annotations')
	...
	for video in video_list:
		...
		for i in range(num_expressions):
			...
			output_ids, pred_masks, pred_boxes = model.evaluate(
				...
				memory_efficient = total_video_len > 50
			)
