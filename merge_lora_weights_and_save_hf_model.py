...
def parse_args(args):
    ...
    parser.add_argument(
        "--version", default="'LLaMA_VID/work_dirs/llama-vid/llama-vid-7b-full-224-video-fps-1'"
    )
    ...
    parser.add_argument("--mm_vision_tower", default='LLaMA_VID/model_zoo/LAVIS/eva_vit_g.pth')
    parser.add_argument("--image_processor", default='LLaMA_VID/llamavid/processor/clip-patch14-224')
    parser.add_argument("--bert_base_uncased", default='bert-base-uncased')
